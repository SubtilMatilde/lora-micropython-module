...
static const uint8_t sTable[16][16] = {
...
void encrypt_payload(uint8_t *data, uint8_t data_length, unsigned int frame_counter, uint8_t direction, uint8_t *dev_addr, uint8_t *app_skey);
void calculate_mic(uint8_t *data, uint8_t *final_MIC, uint8_t data_length, unsigned int frame_counter, uint8_t direction, uint8_t *dev_addr, uint8_t *nwk_skey);
void generate_keys(uint8_t *K1, uint8_t *K2, uint8_t *nwk_skey);
